...
//ToDo genera objetos como : {description: '', complete: false}
...
function buildToDo(todo, index) {
  ...
  toDoText.id = index // <span id= >hola</span>
...
function buildToDos(toDos) {
  ...
  // return arr // [<div class='toDoShell'><span id=0>hola</span></div>,
               //<div class='toDoShell'><span id=1>hola</span></div>,
              // <div class='toDoShell'><span id=2>hola</span></div>]
//-----------------------------------------------------------------------
